...
// hodnoty pre suradnice [0,0] [0,1] [1,0] [1,1] - interpolujeme [x,y]
template <typename T>
T bilinear(const T& v00, const T& v10, const T& v01, const T& v11, Vec p) {
  p.clip();
  return lerp(lerp(v00, v10, p.x), lerp(v01, v11, p.x), p.y);
}
